                                    ...
                                    if($vars)
                                    {
                                        ...
                                        foreach ($vars as $v) {
                                            ...
                                            if($total_vars>=3)
                                                ...
                                                else{$class_name = 'one-var'; }
                                            

                                            if($coulumn==1)
                                            {                                        
                                                if( have_rows('variation_labels') ):
                                                    $row = get_field('table_heading');
                                                    if(isset($row[0])){
                                                        echo '<div class="heading"><div class="txbletxt">'.$row[0]['headng'].'</div></div>';
                                                    }
                                                    echo'<div class="outer-table '.$class_name.'">';
                                                    
                                                    echo'<div class="cls-coulumn-title cls-table-inner">';
                                                    
                                                    echo'<ul class="contentTitle">';
                                                        $i=0;
                                                        while ( have_rows('variation_labels') ) : the_row();
                                                            $field_name = get_sub_field('label');
                                                            echo '<li><div class="record-cls">'.$field_name.':</div></li>';
                                                            $i++;
                                                        endwhile;
                                                        echo '<li><div class="record-cls">Lieferzeit:</div></li>';
                                                        echo '<li><div class="record-cls">Preis inkl. MwSt.:</div></li>';
                                                    echo'</ul></div>';
                                                endif;
                                            }
                                            if($coulumn==4)
                                            {
                                                if( have_rows('variation_labels') ):
                                                    $row = get_field('table_heading');
                                                    if($row[1]){
                                                        echo '<div class="heading"><div class="txbletxt">'.$row[1]['headng'].'</div></div>';
                                                    }
                                                    echo'<div class="outer-table '.$class_name.'">';
                                            ...
                                            if($coulumn==7)
                                            {
                                                if( have_rows('variation_labels') ):
                                                    $row = get_field('table_heading');
                                                    if($row[2]){
                                                        echo '<div class="heading"><div class="txbletxt">'.$row[2]['headng'].'</div></div>';
                                                    }
                                                    echo'<div class="outer-table '.$class_name.'">';
                                            ...
                                            if($coulumn==10)
                                            {
                                                if( have_rows('variation_labels') ):
                                                    $row = get_field('table_heading');
                                                    if($row[3]){
                                                        echo '<div class="heading"><div class="txbletxt">'.$row[3]['headng'].'</div></div>';
                                                    }
                                                    echo'<div class="outer-table '.$class_name.'">';
                                            ...
                                            echo'<div class="cls-coulumn-'.$coulumn.' cls-table-inner"><ul>';
                                            while ( have_rows('variation_labels') ) : the_row();
                                                // update_post_meta( $var_id, '_cstm_label_0', esc_attr( $parent_id ) );
                                                $label='_cstm_label_'.$j;
                                                                    $_text_field_label1 = $label.'['.$v.']';
                                                                            if( ! empty( $_text_field_label1 ) ) {
                                                                                if(strstr(get_post_meta($v, $label, esc_attr( $_text_field_label1)),'youtube.com'))
                                                                                {
                                                                                    echo'<li><div class="record-cls"><a target="_blank" href="'.get_post_meta($v, $label, esc_attr( $_text_field_label1)).'">Video</a></div></li>';
                                                                                }
                                                                                else if(strstr(get_post_meta($v, $label, esc_attr( $_text_field_label1)),'.pdf'))
                                                                                {
                                                                                    echo'<li><div class="record-cls"><a target="_blank" href="'.get_post_meta($v, $label, esc_attr( $_text_field_label1)).'">PDF</a></div></li>';
                                                                                }
                                                                                else
                                                                                {
                                                                                    echo'<li><div class="record-cls">' . get_post_meta($v, $label, esc_attr( $_text_field_label1)) . '</div></li>';
                                                                                }
                                                                            }
                                                                      $j++;
                                            ...
                                            if ($delivery_time) {
                                                echo '<li><div class="record-cls">' . $delivery_time->description . '</div></li>';
                                            } elseif (wc_gzd_get_product( $product )->get_delivery_time_html()) {
                                                echo '<li><div class="record-cls">' . wc_gzd_get_product( $product )->get_delivery_time_html() . '</div></li>';
                                            } else {
                                                echo '<li><div class="record-cls">Lieferung erfolgt innerhalb von 2 Wochen</div></li>';
                                            }

                                            // Germanized
                                            /* if (wc_gzd_get_product( $product )->get_delivery_time_html()) {
                                                        echo '<li><div class="record-cls">' . explode(':', wc_gzd_get_product( $product )->get_delivery_time_html())[1] . '</div></li>';
                                            } */

                                            $price = get_post_meta($v, '_price', true);
                                            echo '<li><div class="record-cls">' . wc_price( $price ).'</div></li>';
                                            echo '<li class="btnList"><div class="record-button btn btnTable"><a href=' . $variation_url . '>In den Warenkorb</a></div></li>';
                                            echo'</ul></div>';
                                            if($coulumn==3)
                                            {
                                                echo'</div>';

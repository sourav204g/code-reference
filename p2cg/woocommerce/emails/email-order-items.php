...
/* DPT 03122020 - END Get ariation name to show in product name in cart item */
	...
	<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
		...
		// Product name.
		/* DPT 03122020 - show variation name instead of product name and variation ID */
		if( ! empty( $description ) ) {
			echo wp_kses_post( apply_filters( 'woocommerce_order_item_name', $description, $item, false ) );
		} else {

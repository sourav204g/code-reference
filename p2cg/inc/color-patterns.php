 ...
 */
function myclassic_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter My Classic default saturation level.
	 *
	 * @since My Classic 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'myclassic_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.myclassic-front-page) .entry-title,
...
.colors-custom .myclassic-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.myclassic-front-page .panel-content .recent-posts article,
...
.colors-custom.myclassic-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters My Classic custom colors CSS.
	 *
	 * @since My Classic 1.0
	 *
	 ...
	 */
	return apply_filters( 'myclassic_custom_colors_css', $css, $hue, $saturation );
}

...
(function($){
				...
				$('.hnd_review_reply_btn').click(function(){

							$('.reply-loader').addClass('replybox-show');

							let reply = $(this).parent().find('.hnd_reply_message').val();
							// console.log(reply);
							...
							$.ajax({
			                    ...
			                    success: function(response) {
			                    	...
			                    	$('.reply-loader').removeClass('replybox-show');

...
var productPrice = parseFloat($('[name="handymn_product_price"]').val());

var finalp = ( basefare_prem - afterDst ) + productPrice;
...
function nextPrev(n) {
  ...
  // } else {
  		  ...
  		  let productPrice = parseFloat($('[name="handymn_product_price"]').val()); 
  		  ...
  		  let hndy_per_min_cost = $('[name="handymn_per_min_cost"]').val();
  		  	...
  		  	if (counter == 0) {
	  			  ...
	  			  productPrice = productPrice * $('[name="hnd_showquantity"]').val();
	  			...
	  			hndy_total_price = hndy_total_price + productPrice;
 			...
 			if (index !== -1 && n !== -1) {
		  		  ...
		  		  // JSON.parse(hnd_opt).forEach(function(elem, index){
		  		  		...
		  		  		if( subOpts[index] !== '' &&  subOpts[index] !== 'null' ) {
		  		  			...
		  		  			if (vis !== 'hide') {
		  		  				selectedOptions += '</div><div class="ybs-value"> $' + addon_price.toFixed(2) + ' USD </div> </li>';
		  		  			}
		  		  			...
		  		  			if( subKey === 'hnd_qty' ) {
		  		  				...
		  		  				selectedOptions += '<li class="ybs-list-item price-section transition-item-enter transition-item-enter-active"><div class="ybs-title ybs8"><h6 class="subheader">' + _qt + '</h6></div><div class="ybs-value">$' + qtycost + '</div></li>';
		  		  				...
		  		  				if( subOpts[index].split('|')[2] !== 'no' ) { // IF yes
		  		  					...
		  		  					selectedOptions += '<li class="ybs-list-item price-section transition-item-enter transition-item-enter-active"><div class="ybs-title ybs8"><h6 class="subheader">' + yesnoL + '</h6></div><div class="ybs-value"><em style="font-style: italic;">(YES)</em> - $' + yes.toFixed(2) + ' USD</div></li>';

		  		  				} else { // IF no

		  		  					selectedOptions += '<li class="ybs-list-item price-section transition-item-enter transition-item-enter-active"><div class="ybs-title ybs8"><h6 class="subheader">' + subOpts[index].split('|')[1] + '</h6></div><div class="ybs-value"><em>(NO)</em style="font-style: italic;"> - $0 USD</div></li>';
		  		  				...
		  		  				if(subon_customer_supply) {
		  		  					...
		  		  					selectedOptions += '<li class="ybs-list-item price-section transition-item-enter transition-item-enter-active"><div class="ybs-title ybs8"><h6 class="subheader">' + subon_label + ' <small class="subheader-small"><b>Customer to Supply: </b>' + subon_customer_supply + '</small></h6></div><div class="ybs-value">$' + list_min_cst.toFixed(2) + ' USD</div></li>';

		  		  				} else {
		  		  					selectedOptions += '<li class="ybs-list-item price-section transition-item-enter transition-item-enter-active"><div class="ybs-title ybs8"><h6 class="subheader">' + subon_label + '</h6></div><div class="ybs-value">$' + list_min_cst.toFixed(2) + ' USD</div></li>';
		  		  				}
...
// console.log(actprctotal);
	function up1(max) {
	    ...
	    $('[name="handymn_prod_quantity"]').val(qtyn);

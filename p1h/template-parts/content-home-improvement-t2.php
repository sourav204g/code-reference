...
if( have_rows('hnd_featured_service_listings_1') ):

 	// loop through the rows of data
    while ( have_rows('hnd_featured_service_listings_1') ) : the_row(); ?>
    	...
    	<div class="col-md-3">
            <div class="handypro-box">
              <article class="wow" style="background: url(<?php echo get_sub_field('hnd_featured_category_image')['url']; ?>);">
    			...
    			<span class="exp-serv2_head"><?php echo get_sub_field('category_heading'); ?></span>
    			<span class="exp-serv2"><a href="#">Explore Services &gt;&gt;</a></span>

                <div class="exp-tech-hover">
                  
                  <div class="for-mob" style="display: block;"></div>
                  
                  <div class="exp-inner-main mobile-v1">
                    
	    					<div class="exp-inner-brd mobile-v1">
	    						<h4><?php echo get_sub_field('hnd_featured_listing'); ?><span class="homediscount"> <?php if (get_sub_field('hnd_todays_discount')): ?>
									<h5> <?php echo get_sub_field('hnd_todays_discount'); ?>% OFF</h5>
								<?php else: ?>
								<?php endif; ?></span></h4>
	    						
	    						<?php /* if (get_sub_field('hnd_todays_discount')): ?>
									<h5>Today's Discount <?php echo get_sub_field('hnd_todays_discount'); ?>% OFF</h5>
								<?php else: ?>
									<h5>Today's Featured Service Listings</h5>
								<?php endif; */ ?>
	    						...
	    						<?php if (get_sub_field('hnd_featured_listing_id')): ?>
	    							...
	    							<a class="learn-more reveal" 
	    							data-title="<?php echo get_sub_field('hnd_featured_listing'); ?>" 
	    							data-cid="<?php echo get_sub_field('hnd_featured_listing_id'); ?>" 
	    							data-banner-text="<?php echo get_field('services_banner_text', 'service_categories_' . get_sub_field('hnd_featured_listing_id')); ?>" 
	    							data-banner-link="<?php echo get_field('services_banner_link', 'service_categories_' . get_sub_field('hnd_featured_listing_id')); ?>" 
	    							data-count="<?php echo $cath->count; ?>">View all (<?php echo $cath->count; ?>) <?php // echo get_sub_field('hnd_featured_listing'); ?> Services</a>

	    							<!-- <a class="learn-more" href="<?php // echo get_sub_field('hnd_featured_cat_link') ?>">View all (<?php // echo $cath->count; ?>) <?php // echo get_sub_field('hnd_featured_listing'); ?> Services</a> -->

	    						<?php else: ?>

	    							<a class="learn-more" href="<?php echo get_sub_field('hnd_featured_cat_link') ?>">View all <?php // echo get_sub_field('hnd_featured_listing'); ?> Services</a>
...
<?php  $Pindex++; // display a sub field value

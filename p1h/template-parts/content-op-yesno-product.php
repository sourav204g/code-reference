			...
			<div class="ptagq">
				...
				<label for="<?php echo $outerKey . '|' . $innerKey . '|' . $subkey . '|' . '0'; ?>">
					...
					<input id="<?php echo $outerKey . '|' . $innerKey . '|' . $subkey . '|' . '0'; ?>" 
					       ...
					       type="radio" 
					       value="<?php echo $handyman_sub_option_group['handyman_so_yesno_labour_minutes'] . '|' . $suboptionyesnoMaterial; ?>" data-cap="<?php echo $hnd_yesnoLabel_yes; ?>" data-premium="<?php echo get_field('handyman_product_premium', $getServiceID); ?>" data-discount="<?php echo get_field('handyman_product_discount', $getServiceID); ?>"> Yes
				</label>

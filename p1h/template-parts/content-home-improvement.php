...
if( have_rows('hnd_featured_service_listings_1') ):
    ...
    while ( have_rows('hnd_featured_service_listings_1') ) : the_row(); 
    	...
    	if (get_sub_field('hnd_special_link')) {
    		$special_link = true;
    	}
    	...
    	<div class="col-lg-3 col-md-6">
            ...
            <div class="handypro-box">
              ...
              <article class="wow <?php echo ($special_link) ? 'special-link' : ''; ?>" style="background: url(<?php echo get_sub_field('hnd_featured_category_image')['url']; ?>);">
                  ...
                  <div class="exp-inner-main mobile-v1">
	    					...
	    					<div class="exp-inner-brd mobile-v1">
	    						...
	    						<?php endif; ?>
	    						    						...
	    						    						<?php if (get_sub_field('hnd_special_link')): ?>

	    																<div class="hnd-special">
	    										                <a href="<?php echo get_sub_field('hnd_special_link'); ?>"><?php echo get_sub_field('hnd_special_label'); ?><br/><span>Available only through online scheduling.</span></a>
	    										            </div>
...
// echo " Execution time of script = " . round($execution_time, 2) . " sec";

...
.exp-tech-hover .learn-more i.fa {
    font-size: 18px;
}
/*.exp-inner-main.remodeling ul li{
    color: #323232;
    font-weight: 600;
    line-height: 16px;
}*/
/*.exp-inner-main.remodeling ul li span{
    font-size: 14px!important;
}*/
.exp-inner-main.remodeling .servicce-hvr-type a span {
    font-weight: 400;
}
</style>
                  ...
                  <div class="row heading-pro">
                    ...
                    <div class="col-md-10 hand-auto">
                          ...
                          <div class="handy-pro-but02">
                             <a class="btn" href="https://handymanproservices.com/all-services/"><span><img class="hdy-img" src="https://handymanproservices.com/wp-content/themes/handyman_pro/assets/images/budget-btn011.png" /></span> <span>Browser All Services</span></a>
                            </div>
                      
                          <div class="handy-pro-but01">
                             <a class="btn" href="https://handymanproservices.com/services/general-handyman-work/"><span><img class="hdy-img" src="https://handymanproservices.com/wp-content/themes/handyman_pro/assets/images/calendar-btn-03.png" /></span><span>Book a Handyman From <?php // echo '$' . $general_cost . ' USD' ; ?></span></a>
                            </div>                         
                        
                          <div class="handy-pro-but03">
                             <a class="btn" href="https://handymanproservices.com/get-a-free-estimate/"><span><img class="hdy-img" src="https://handymanproservices.com/wp-content/themes/handyman_pro/assets/images/hammer-btn02.png" /></span><span>Get A Free Estimate</span></a>
                            </div>
                    </div>
...
<section class="home-exp-sec whbg2 pop">
    <div class="fix-wrap shell">
      <div class="xtitle-btn">
        
        <div class="row heading-pro2">

          <div class="col-md-12 hnd-form-section">
            <form id="searchform" method="get" action="https://www.handymanproservices.com/" class="search-form" autocomplete="off">
                <input type="text" id="company_works_at" class="search-field" name="s" placeholder="What project can we help with?" value="">
  ...
  <section class="home-exp-sec" id="expertise" style="padding-top: 0px; ">
      <div class="fix-wrap shell">
        <div class="xtitle-btn">
                  <div class="row heading-pro">
...
<!--                     <div class="col-md-10 hand-auto">                      
                          ...
                          <div class="handy-pro-but03">
                             <a class="btn" href="https://handymanproservices.com/get-a-free-estimate/"><span><img class="hdy-img" src="https://handymanproservices.com/wp-content/themes/handyman_pro/assets/images/hammer-btn02.png" /></span>
  ...
  <!-- Services Section 2 -->
  <section class="home-exp-sec gray pop">
    <div class="fix-wrap shell">
      <div class="xtitle-btn">
                <div class="row heading-pro2">
          ...
          <div class="row">
            ...
            <?php get_template_part( 'template-parts/content', 'home-improvement' ); ?>
  ...
  <?php if( have_rows('hnd_maintenance_projects') ): ?>

  <section class="home-exp-sec gray">
    <div class="fix-wrap shell">
      <div class="xtitle-btn">
                <div class="row heading-pro2">
                  <div class="col-md-10 col-8">
            <h2>Maintenance Projects <span>Improve your home value with our affordable remodeling projects.</span></h2>
            <!-- <p></p> -->
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <a href="https://www.handymanproservices.com/get-a-free-estimate/" style="background: #de3549;">Can't Find it? Set Your Own Price & Book Now</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3">
        <a href="https://handymanproservices.com/get-a-free-estimate/">Get a Free Estimate</a>
      </div>
    </div>
  </div>
</section> -->
          ...
          <div class="row" id="team-carousel">
                      ...
                      <div class="exp-inner-main remodeling">
                        <div class="exp-inner-brd">
                          <h4 class="exp-inner-brd-heading"><?php echo get_sub_field('featured_listing_heading_product'); ?></h4>
                            <p class="prd-tax-txt">Price Include Product Taxes & Installation</p>
                          ...
                          <?php if (get_term( $pcatID, 'product_categories' )): ?>
                            ...
                            <a class="learn-more" href="<?php echo get_sub_field('featured_listing_link_product'); ?>">View all (<?php echo get_term( $pcatID, 'product_categories' )->count; ?>) Products <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>

                          <?php else: ?>

                            <a class="learn-more" href="<?php echo get_sub_field('featured_listing_link_product'); ?>">View all Products <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
            ...
            <!-- <div class="col-12 col-md-3">
              <div class="handypro-box2">
                ...
                <article class="wow">
                  <img alt="" src="https://handymanproservices.com/wp-content/themes/handyman_pro/assets/images/hnd-pro-img01.jpg" style="width: 100%;">
                  <div class="exp-tech-hover">
                    ...
                    <div class="exp-inner-main">
                      <div class="exp-inner-brd">
                        ...
                        <ul>
                          <li>
                            <a href="https://handymanproservices.com/services/ceramic-tiling-3/"><span>Kitchen aid 1/2 HP garbage disposal with sound insulation</span><br>
                            Replacement <del>$221.67</del> - $117.48<br>
                            New Installation <del>$221.67</del> - $117.48<br></a>
                          </li>
                          <li>
                            <a href="https://handymanproservices.com/services/hardwood-flooring/"><span>GE 1/2 HP garbage disposal with sound insulation</span><br>
                            Replacement <del>$221.67</del> - $117.48<br>
                            New Installation <del>$221.67</del> - $117.48<br></a>
                          </li>
                        </ul><a class="learn-more" href="https://handymanproservices.com/service-categories/flooring-tiling/">View all (20) Products</a>
                      </div>
                    </div>
                  </div>
                </article>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="heading">
              ...
              <h2>How <a class="hyd-work">Handyman Pros</a> Works <a data-target="#exampleModal" data-toggle="modal" href="#"><img alt="" src="<?php bloginfo('template_directory'); ?>/assets/images/video-icon.png" style="width:60px; margin-bottom: -15px; margin-left: 12px;"></a></h2>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="job-grid">
                    ...
                    <div class="job-title-sec">
                      ...
                      <h2 style="font-size:24px;"><a href="https://www.angieslist.com/companylist/us/il/northwest-suburbs/handyman-pros-reviews-103845.htm" title="">Testimonial</a></h2>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 bbb-hidde">
                          ...
                          <a href="https://www.bbb.org/chicago/business-reviews/general-contractor/handyman-pros-in-mundelein-il-12012461/" target="_blank"><img alt="" src="<?php bloginfo('template_directory'); ?>/assets/images/bbb-business.png"></a>
                        ...
                        <?php if (get_field('hnd_award')): ?>
                          ...
                          <div class="col-md-6">
                            ...
                            <a href="https://www.angieslist.com/companylist/us/il/northwest-suburbs/handyman-pros-reviews-103845.htm">
                        ...
                        <div class="col-md-6">
                          ...
                          <a href="https://www.angieslist.com/companylist/us/il/northwest-suburbs/handyman-pros-reviews-103845.htm"><img alt="" src="<?php bloginfo('template_directory'); ?>/assets/images/angieslist-review.png"></a>

                        </div>

                      </div><span class="fav-job"><i class="la la-heart-o"></i></span>

                    </div><a href="https://www.angieslist.com/companylist/us/il/northwest-suburbs/handyman-pros-reviews-103845.htm" title="">SEE ALL OF OUR PROS REVIEWS</a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="job-grid">
                    ...
                    <div class="job-title-sec">
                      ...
                      <p>We are working hard to make your experience with us very positive. Please see our full story and our compelling history.</p><a href="https://www.bbb.org/chicago/business-reviews/general-contractor/handyman-pros-in-mundelein-il-12012461/" target="_blank"><img alt="" src="<?php bloginfo('template_directory'); ?>/assets/images/bbb-business.png"></a>

                      <div class="row">

                      <!--   <div class="col-md-6 bbb-hidde">

                          <a href="https://www.angieslist.com/companylist/us/il/northwest-suburbs/handyman-pros-reviews-103845.htm"><img alt="" src="<?php // bloginfo('template_directory'); ?>/assets/images/SuperServiceAward.png"></a>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="handy-star-pro">
              ...
              <div><a href="http://handymanproadmin.azurewebsites.net/" target="_blank">Details & Demo</a></div>
              </div>
          </div>
          <div class="col-lg-6">

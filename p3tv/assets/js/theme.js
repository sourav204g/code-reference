(function ($) {
  ...
  if ($(".main-nav__main-navigation li.menu-item-has-children ul").length) {
    $(".main-nav__main-navigation li.menu-item-has-children")
      .children("a")
      .append(
  ...
  $(window).on("load", function () {
    ...
    if ($(".latest_listings_carousel").length) {
     ...
     // Photograper Listings
    if ($(".photograper_listings_carousel").length) {
      $(".photograper_listings_carousel").owlCarousel({
        loop: true,
        margin: 0,
        nav: true,
        stagePadding:0,
